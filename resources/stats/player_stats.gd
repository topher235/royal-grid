...
func get_display_values() -> Dictionary:
    ...
    return {
        ...
        "STATS_TOTAL_PIECES_CAPTURED": total_pieces_captured,
        "STATS_TOTAL_MOVES_MADE": total_moves_made,
        "STATS_PAWN_CAPTURES": pawn_captures,
        "STATS_ROOK_CAPTURES": rook_captures,
        "STATS_KNIGHT_CAPTURES": knight_captures,
        "STATS_BISHOP_CAPTURES": bishop_captures,
        "STATS_QUEEN_CAPTURES": queen_captures,
        "STATS_KING_CAPTURES": king_captures,
        "STATS_TOTAL_PLAY_TIME": total_play_time,
        "STATS_SESSIONS_PLAYED": sessions_played,
        "STATS_HIGHEST_MULTIPLIER": highest_multiplier,
    }
